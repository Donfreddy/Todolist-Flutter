    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          Center(
            child: Text(
              Translations.of(context).text('Add new event'),
          ...
          CustomTextField(
              labelText: Translations.of(context).text('Enter event name')),
          SizedBox(height: 12),
          CustomTextField(
              labelText: Translations.of(context).text('Enter description')),
          SizedBox(height: 12),
